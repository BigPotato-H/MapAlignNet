...
def deeplabv3_hrnetv2_48(num_classes=21, output_stride=4, pretrained_backbone=False): # no pretrained backbone yet
    return _load_model('deeplab', 'hrnetv2_48', output_stride, num_classes, pretrained_backbone=pretrained_backbone)

def deeplabv3_hrnetv2_32(num_classes=21, output_stride=4, pretrained_backbone=True):
    return _load_model('deeplab', 'hrnetv2_32', output_stride, num_classes, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    """
    return _load_model('deeplab', 'resnet50', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplab', 'resnet101', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_mobilenet(num_classes=21, output_stride=8, pretrained_backbone=True, **kwargs):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplab', 'mobilenetv2', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def deeplabv3_xception(num_classes=21, output_stride=8, pretrained_backbone=True, **kwargs):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplab', 'xception', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
