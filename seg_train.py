...
from seg_engine import train, validate
...
if __name__ == '__main__':
    ...
    train_dataset = argoLoader(opt.input_dir, 'train', opt)
    ...
    save_metrics_to_csv(
        train_pix_acc, valid_pix_acc, train_loss, valid_loss, out_dir, out_csv_name)
